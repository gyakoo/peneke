...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "peneke.py"
 
        #Name of program
        self.project_name = "peneke"
        ...
        #Description
        self.project_description = "Peneke game"
        ...
        self.extra_modules = ["six"]
        self.exclude_modules = []
        
        #DLL Excludes
        self.exclude_dll = ['']
        #python scripts (strings) to be included, seperated by a comma
        self.extra_scripts = ["pytmx"]
...
if __name__ == '__main__':
    ...
    sys.path.insert( 1, os.path.join(sys.path[0], "pytmx") )
